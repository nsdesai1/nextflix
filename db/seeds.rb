...
popular = Genre.create!(name: "Popular")
...
video1 = Video.create!(
    ...
    video1.genres += [scifi, action, popular]
...
video4 = Video.create!(
    ...
    video4.genres += [scifi, thriller]

video5 = Video.create!(
    title: "The Grand Budapest Hotel", 
    description: "A hotel concierge recounts his adventures at a famous European hotel, including the theft and recovery of a priceless Renaissance painting and the battle for an enormous family fortune.", 
    media_type: "movie", 
    duration: "1h 40m", 
    rating: "R", 
    year: "2014")
    ...
    video5.genres += [comedy, drama, popular]
...
video6 = Video.create!(
    ...
    video6.genres += [comedy, thriller, drama, popular]
...
video7 = Video.create!(
    ...
    video7.genres += [comedy, drama, popular]

video8 = Video.create!(
    title: "The Wolf of Wall Street", 
    description: "From the American dream to corporate greed, New York stockbroker Jordan Belfort goes from penny stocks and righteousness to IPOs and a life of corruption in the late 80s.", 
    media_type: "movie", 
    duration: "2h 59m", 
    rating: "R", 
    year: "2013")
...
video10 = Video.create!(
    ...
    video10.genres += [action, thriller, popular]
...
video12 = Video.create!(
    ...
    video12.genres += [thriller, popular]
...
video13 = Video.create!(
    ...
    video13.genres += [action, scifi, popular]
